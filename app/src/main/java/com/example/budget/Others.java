...
public class Others extends Fragment implements BillListener{
    public ArrayList<card_bills> bills,emi;
    public RecyclerView recyclerView;
    public RecyclerView.LayoutManager manager;
    public Fragment_Recycler_Adapter adapter;
    public OthersFragmentListener listener;

    public Others(ArrayList<card_bills> bills, OthersFragmentListener listener) {
        this.bills = bills;
    ...
    public interface OthersFragmentListener {
